...
public class Vertex {
  ...
  private double onlineSum; // sum of online entries values
  private double entryCount; // # of entries
  ...
  public Vertex(Vertex other) {
    this(other.getX(), other.getY(), other.getZ(), other.getTimestamp());
  ...
  public double getOnlineAvg() {
    return onlineSum / entryCount;
  }

  public void addEntry(double online) {
    entryCount++;

    onlineSum += online;
  }

  public void addEntry(double online, double count) {
    entryCount += count;

    onlineSum += online;
  }

  public void addEntry(Vertex entry) {
    entryCount += entry.getEntryCount();

    onlineSum += entry.getOnlineSum();
  }
  ...
  void addElementAdjList(int v) {
    ...
    this.adjacencyList.add(Integer.valueOf(v));
  }
